(function ($) {
    ...
    $.fn.contextmenu = function (option) {
        ...
        itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr unselectable=on><span class='$[icon]' style='display:block;float:left;margin-right:8px;'></span><span unselectable=on  style='display:block;float:left'>$[text]</span></nobr></div>";
